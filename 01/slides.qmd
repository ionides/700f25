...
- The pre-history of phylodynamics and its initial synthesis by \citet{Grenfell2004}.
    ...
    + Challenges for interpretation of the resulting trees of ancestral relationships.
...
__Note__: ``observed trees'' are derived data, usually constructed from aligned genetic sequence data. These sequences are derived data from uncertain estimates pieced together from genetic fragments measured sequencing machines. We depend on a bioinformatics pipeline extending beyond the topic of this course.
...
* Formal quantitative inference also has a role.
    ...
    + Models enable statistical statements when compared to data.
...
* There are many words to look up on Google/Wikipedia/ChatGPT.

* The paper focuses on the forward problem: how does biology explain the observed tree?
...
* Chance interactions between S and I individuals may lead to a transmission event ($S\rightarrow I$) and a new infection.
<!--
\begin{eqnarray}
S + I \rightarrow 2I
\end{eqnarray}
...
* If each new infection has a unique source, called its ancestor, the sequence of random infection events implies a random ancestral tree connecting any collection of observed individuals.
...
Which of the following are at least somewhat familiar to you? Can you say what they mean to you in a few words?
...
__Statistics__. Maximum likelihood estimate.  Efficient estimate. Akaike's information criterion.  Importance sampling. Markov chain Monte Carlo. Sequential Monte Carlo. Fisher information.  
...
EIP: Evolutionary Infectivity Profile, combining abundance and selective pressure.
...
\includegraphics[width=6cm]{fig1C.png} \includegraphics[width=3cm]{fig1G.png}

\includegraphics[width=4cm]{fig1I.png} HIV dynamics (Fig. 1)


----

## Recent uses of phylodynamics

* Estimation of epidemiological model parameters

* Estimating time of emergence of new pathogens before detection and identification

* Phylogeography: trees with spatially labeled leaves can reveal spread

* Identification of new pathogen strains having a competitive advantage


----

\includegraphics[width=8.8cm]{nguyen25-fig2a.png}  
\citet{Nguyen2025}, Fig. 2. Highly pathogenic avian influenza
