...
* Key idea: finding the closest approximation to a Bayesian posterior within a tractable model class can be much easier than finding the exact posterior.

* This approximation problem involves maximization, not Monte Carlo sampling.
